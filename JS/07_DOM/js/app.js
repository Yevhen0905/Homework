...
const tegHeader = document.querySelector('.header'); //взяли селектор
// tegHeader.innerHTML = `<h1> ${'PLAYLIST'} </h1>`; //другий варіант
const h1 = document.createElement('h1'); //створив тег
const img = document.createElement('img'); //створив тег
img.setAttribute('src', 'https://previews.123rf.com/images/butenkow/butenkow1711/butenkow171100727/90745568-vector-logo-music.jpg')
// img.setAttribute('class', 'logo'); // додав клас
...
const domPlayList = document.getElementById('playlist');
// пройтись по об'єкту
playList.forEach(item => {
    let li = document.createElement('li'); //створив li
    let p = document.createElement('p');  //створив р
    let span = document.createElement('span'); //створив span
