...
checkArr(myArr1); // Function expression

var calculator = function calculator(a, b, operator) {
  var localA = parseFloat(a); //передбачення 

  var localB = parent(b); //передбачення
...
console.log(calculator(40, 50, '+')); // В кожній функції повинен бути обробленний крайній випадок коли не корректні дані, які зламають все
// IIFE 
// Immediately  Негайно
// Invoked  Викликано
// Function
